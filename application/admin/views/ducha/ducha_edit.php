...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                <span style="float:left">当前位置是：督促管理-》督促列表-》修改督促</span>
                
            </span>
        </div>
        <div></div>
		<a class="btn btn-primary" id="addnew" href="<?php echo site_url('ducha/show');?>">返回列表<span class="glyphicon glyphicon-plus"></span></a>
        
        <div style="font-size: 13px;margin: 10px 5px">
            
            <?php echo form_open_multipart('ducha/edit');?>
