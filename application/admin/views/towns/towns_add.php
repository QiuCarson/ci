...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                <span style="float:left">当前位置是：镇街管理-》镇街列表-》添加镇街</span>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <form action="<?php echo site_url('towns/add');?>" method="post" >
            <input type="hidden" name="action" value="do_add" />
            <table border="1" width="100%" class="table_a">
                <tr>
                    <td>镇街名</td>
                    <td><input type="text" name="name" /><font color=red>*不可以为空</font></td>
                </tr>
